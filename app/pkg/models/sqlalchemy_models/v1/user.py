...
class User(Base):
    ...
    user_username: Mapped[str] = mapped_column(unique=True, index=True, nullable=False)
    ...
    user_create_at: Mapped[datetime] = mapped_column(server_default=func.now(), nullable=False)
